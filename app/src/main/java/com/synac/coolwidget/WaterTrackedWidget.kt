...
private val WATER_COUNT_KEY = intPreferencesKey(name = "water_count")

object WaterTrackedWidget : GlanceAppWidget() {
    ...
    Column(
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically,
                ...
                Image(provider = ImageProvider(R.drawable.ic_water_glass),
...
class IncrementWaterAction : ActionCallback {
    override suspend fun onAction(
        ...
        WaterTrackedWidget.update(context, glanceId)
    }
}
...
class WaterTrackerWidgetReceiver: GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = WaterTrackedWidget
}